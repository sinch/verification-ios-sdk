...
public class VerificationApiCallback {
    ...
    public init (listener: VerificationListener?, verificationStateListener: VerificationStateListener?) {
        self.listener = listener
        self.verificationStateListener = verificationStateListener
    }
    
    internal func handleResponse(_ response: ApiResponse<VerificationResponseData>) {
