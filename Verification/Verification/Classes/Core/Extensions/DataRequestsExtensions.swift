...
extension DataRequest {
    ...
    func sinchResponse<T: Decodable> (resultCallback: @escaping (_ response: ApiResponse<T>) -> Void) {
    ...
    func sinchInitiationResponse(_ callback: InitiationApiCallback) {
        sinchResponse(resultCallback: callback.handleResponse)
    }
    
    func sinchValidationResponse(_ callback: VerificationApiCallback) {
        sinchValidationResponse(resultCallback: callback.handleResponse)
    }
    
    fileprivate func sinchValidationResponse(resultCallback: @escaping (_ response: ApiResponse<VerificationResponseData>) -> Void) {
