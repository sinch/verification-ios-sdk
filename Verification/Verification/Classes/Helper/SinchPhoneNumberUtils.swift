...
public class SinchPhoneNumberUtils {
    ...
    static func formatNumberToE164(_ number: String, forCountryIso countryIso: String = defaultCountryIso) -> String? {
    ...
    static func isPossiblePhoneNumber(_ number: String, forCountryIso countryIso: String = defaultCountryIso) -> Bool {
    ...
    static var defaultCountryIso: String {
