#
#  Be sure to run `pod spec lint Verification.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of Verification."
  ...
  spec.homepage     = "http://EXAMPLE/Verification"
  ...
  # Or just: spec.author    = "Aleksander Wójcik"
  # spec.authors            = { "Aleksander Wójcik" => "aleksander.wojcik@sinch.com" }
  # spec.social_media_url   = "https://twitter.com/Aleksander Wójcik"
